...
Environment=NODE_ENV=production-linux NODE_CONFIG_DIR=/etc/M4_DS_PREFIX NODE_DISABLE_COLORS=1 PKG_NATIVE_CACHE_PATH=/tmp/.cache APPLICATION_NAME=M4_COMPANY_NAME
